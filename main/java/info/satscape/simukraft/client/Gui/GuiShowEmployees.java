...
public class GuiShowEmployees extends GuiScreen
{
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        drawCenteredString(fontRenderer, "Employees", width / 2, 17, 0xffffff);
        int y = 35;
        ...
        for (int ff = folkOffset; ff < this.folks.size(); ff++)
        {
            ...
            //name
            drawString(fontRenderer, folk.name, 2, y, 0xA0ffff);

            //vocation and dimension
            if (folk.employedAt == null)
            {
                drawString(fontRenderer, "Unemployed", 110, y, 0xff1010);
            }
            else
            {
                String dime = "";
                ...
                drawString(fontRenderer, voc, 110, y, 0xA0ffff);
            }
            ...
            drawString(fontRenderer, status, 250, y, 0xA0ffff);
            y += 20;
