...
public class GuiTerraform extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        tfRadius = new GuiTextField(fontRenderer, width / 2 - 50, height - 55, 100, 20);
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        drawCenteredString(fontRenderer, "Terraforming - Please choose a Terraforming theme", width / 2, 17, 0xffffff);
        drawCenteredString(fontRenderer, "Radius (1 to 60)", width / 2, height - 70, 0xffffff);
        drawCenteredString(fontRenderer, errorText, width / 2, height - 80, 0xff8080);
