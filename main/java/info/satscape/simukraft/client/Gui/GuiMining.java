...
public class GuiMining extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        {
            tfSize = new GuiTextField(fontRenderer, width / 2 - 25, height - 50, 50, 15);
    ...
    public void drawScreen(int i, int j, float f)
    {
        try
        {
            ...
            drawCenteredString(fontRenderer, "Mining", width / 2, 17, 0xffffff);

            try
            {
                if (theMiningBox.marker1XYZ == null)
                {
                    drawCenteredString(fontRenderer, "Error: No markers placed - 3 markers are needed to mine vertically, 1 marker for horizontal.",
                                       width / 2, 27, 0xff0000);
                }
            }
            catch (Exception e)
            {
                drawCenteredString(fontRenderer, "Error: Please place markers BEFORE the mining box",
                                   width / 2, 27, 0xff0000);
            }
            ...
            if (theMiningBox != null)
            {
                try
                {
                    if (theMiningBox.marker1XYZ != null && theMiningBox.marker2XYZ == null)
                    {
                        drawCenteredString(fontRenderer, "Size of Horizontal mine", width / 2, height - 60, 0xffffaa);
                        tfSize.drawTextBox();
                    }
                }
                catch (Exception e)
