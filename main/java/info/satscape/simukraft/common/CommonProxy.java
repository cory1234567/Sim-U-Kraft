...
public class CommonProxy
{
    ...
    public static class Commodity
    {
        ...
        private static void setupAvailableItems()
        {
            ...
            availableItems.add(new ItemStack(Item.enderPearl));
            availableItems.add(new ItemStack(Item.blazeRod));
            availableItems.add(new ItemStack(Item.bone));
            availableItems.add(new ItemStack(Item.gunpowder));
            availableItems.add(new ItemStack(Item.slimeBall));
            availableItems.add(new ItemStack(Item.silk));  //string
            availableItems.add(new ItemStack(Item.spiderEye));
        }
    }
