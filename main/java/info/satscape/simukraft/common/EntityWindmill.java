...
public class EntityWindmill extends Entity {
	...
	@Override
	public void setDead() {
		ModLoader.getMinecraftInstance().sndManager.stopEntitySound(this);
	...
	public void onUpdate() {
		//this.kill();
		ModLoader.getMinecraftInstance().sndManager.playEntitySound("satscapesimukraft:windmill", this,0.6f,1.0f,false);
