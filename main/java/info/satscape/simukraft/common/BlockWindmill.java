	...
	public BlockWindmill(int par1, boolean par2) {
	 ...
	 @Override
		...
		public void onBlockPlacedBy(World world, int x, int y,
			...
			TileEntityWindmill teWindmill = (TileEntityWindmill)world.getBlockTileEntity(x,y,z);
			if (teWindmill !=null) {
		...
		public ArrayList<ItemStack> getBlockDropped(World world, int x, int y,int z, int metadata, int fortune) {
	    	...
	    	try {
				TileEntityWindmill te=(TileEntityWindmill) world.getBlockTileEntity(x, y, z);
	    ...
	    {
	    	TileEntityWindmill te = (TileEntityWindmill)par1World.getBlockTileEntity(par2, par3, par4);
	    ...
	    public boolean onBlockActivated(World world, int i, int j, int k,
	            ...
	            {
	                TileEntityWindmill tileentitywindmill = (TileEntityWindmill)world.getBlockTileEntity(i,j,k);
