...
public class JobFisherman extends Job implements Serializable
{
    ...
    {
        V3 water = Job.findClosestBlockType(theFolk.employedAt, Block.waterStill, 5, false);
    ...
    private void stageCaughtFish()
    {
        ...
        if (dockChests.size() == 0)
        {
            ...
            {
                theFolk.theEntity.dropItem(Item.fishRaw.itemID, 1);
            }
        }
        else
        {
            inventoriesPut(dockChests, new ItemStack(Item.fishRaw, 1), true);
        }
    ...
    private void stageSellingFish()
    {
        ...
        if (step == 1)
        {
            ...
            if (ModSimukraft.theFolks.size() > 1)
            {
                ...
                dockChests = inventoriesFindClosest(theFolk.employedAt, 4);
                fishStack = inventoriesGet(dockChests, new ItemStack(Item.fishRaw, sell), false,false,-1);
            }
